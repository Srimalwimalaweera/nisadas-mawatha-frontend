...
const DarkModeToggle = ({ isDarkMode, toggleTheme }) => {
  return (
    <label className="switch">
      ...
      />
      {/* Sun Icon */}
      <svg className="switchIcon switchIconLight" viewBox="0 0 12 12" width="12px" height="12px" aria-hidden="true">
      ...
      {/* Moon Icon */}
      <svg className="switchIcon switchIconDark" viewBox="0 0 12 12" width="12px" height="12px" aria-hidden="true">
      ...
      <span className="switchSr">Dark Mode</span>
    </label>
  );
};
